...
function Populate(){
  ...
  const [assessmentID, setAsssessmentID] = useState(41);
    ...
    const submitFunc = async () => {
        ...
        for(let k = 0 ; k < 3 ; k += 1){
            ...
            console.log(postData);
                ...
                axios.post('http://localhost:8000/assessments/assessment/'.concat(assessmentID).concat('/question/'), postData ,{headers: {
                ...
                let Options = [data[i].option1, data[i].option2, data[i].option3, data[i].option4];
                for(let j = 1 ; j <= 4 ; j += 1){
