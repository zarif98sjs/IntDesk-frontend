...
function AssessForm() {
  ...
  const submitFunc = async () => {
    ...
    await axios
      .post("https://intdesk.herokuapp.com/assessments/assessment/", postData, {
        headers: {
  ...
  return (
    <div className="">
      <div>
        ...
        <div id="input_num">
          Taken By : <InputNumber defaultValue={0} onChange={takenByChange} />
        </div>
        <br />
        <div id="input_num">
          Passed By : <InputNumber defaultValue={0} onChange={passedByChange} />
        </div>
        <br />
        <Input
          id="title"
