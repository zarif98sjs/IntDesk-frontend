...
function AssessmentsMine() {
  ...
  function countDays(time) {
    ...
    return difference
      .toString()
      .concat(" more days before you can retake the assessment");
  }
          ...
          renderItem={(item, index) => (
            <List.Item>
              <List.Item.Meta
                ...
                title={
                  <a href={validLink(item.ID, takenTimes[index])}>
                    {item.skill_name}
                  </a>
                }
                description={
                  <p>
                    {countDays(takenTimes[index])}
                    <br />
                    Last taken on{" "}
                    {Moment(takenTimes[index]).format("DD MMM,YYYY")}
                    <br />
                  </p>
                }
              />
          ...
          renderItem={(item, index) => (
            <List.Item>
              <List.Item.Meta
                ...
                description={
                  <p>
                    {countDays(takenTimesTemp[index])}
                    <br />
                    Last taken on{" "}
                    {Moment(takenTimesTemp[index]).format("DD MMM,YYYY")}
                    <br />
                  </p>
                }
              />
